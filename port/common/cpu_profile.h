 ...
 *----------------------------------------------------------------------------*/
#if defined(STM32F100RB) && !defined(ES_HAL_CPU_ENABLED)
# if defined(PORT_ARM_NONE_EABI_GCC_)
#  include "arm-none-eabi-gcc/hal/cm3/cm3_cpu.h"
# endif
#endif
 ...
 *----------------------------------------------------------------------------*/
#if defined(STM32L152RB) && !defined(ES_HAL_CPU_ENABLED)
# if defined(PORT_ARM_NONE_EABI_GCC_)
 ...
 *----------------------------------------------------------------------------*/
#if defined(STM32F407VG) && !defined(ES_HAL_CPU_ENABLED)
# if defined(PORT_ARM_NONE_EABI_GCC_)
#  include "arm-none-eabi-gcc/hal/arch/cm3/cm3_cpu.h"
# endif
#endif
 ...
 *
 *============================================================================*/
#if defined(ATMEGA32U2) && !defined(ES_HAL_CPU_ENABLED)
...
/** @endcond *//** @} *//******************************************************
 * END of cpu_profile.h
 ******************************************************************************/
#endif /* CPU_PROFILE_H_ */
